...
export default function EmployeeReportsPage() {
  ...
  const stats = {
    ...
    approvedHours: Math.round(approvedEntries.reduce((sum, e) => sum + e.durationMinutes, 0) / 60 * 10) / 10,
  }

  // Group by project - only count approved entries
  const hoursByProject = approvedEntries.reduce((acc, entry) => {
